              ...
              <div className="grid gap-4">
                <div className="rounded-lg border p-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <p className="font-medium">Latest Tweet</p>
                      <p className="text-sm text-muted-foreground">2 hours ago</p>
                    </div>
                  </div>
                  <p className="mt-4">Just launched our new product! Check it out at example.com #launch #product</p>
                </div>
                <div className="rounded-lg border p-4">
                  <div className="flex items-center gap-4">
                  ...
                  <p className="mt-4">Behind the scenes look at our latest photoshoot 📸 #behindthescenes</p>
                </div>
              </div>
            </section>
          </div>
